...
<nav class="navbar navbar-default navbar-fixed-top">
    <div class="container">
        ...
        <div class="navbar-header">
            ...
            <a href="<%=basePath %>index.jsp" class="navbar-brand">民宿预定平台</a>
        </div>
        <!--小屏幕导航按钮和logo-->
        <!--导航-->
        <div class="navbar-collapse collapse">
            <ul class="nav navbar-nav navbar-left">
                ...
                <li><a href="<%=basePath %>Minsu/frontlist">民宿查询</a></li>
                <li><a href="<%=basePath %>Area/frontlist">地区查询</a></li>
                <li><a href="<%=basePath %>Comment/frontlist">评论查询</a></li>
             ...
             <ul class="nav navbar-nav navbar-right">
             	<%
				    ...
				    if(user_name==null){
	  			%> 
	  			<li><a href="<%=basePath %>Owner/owner_frontAdd.jsp"><i class="fa fa-sign-in"></i>&nbsp;&nbsp;房东注册</a></li>
                <li><a href="#" onclick="login();"><i class="fa fa-user"></i>&nbsp;&nbsp;房东登录</a></li>
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu" aria-labelledby="dLabel">
                        ...
                        <li><a href="<%=basePath %>Minsu/minsu_szFrontAdd.jsp"><span class="glyphicon glyphicon-user"></span>&nbsp;&nbsp;发布民宿房屋</a></li>
                        <li><a href="<%=basePath %>Minsu/szFrontlist"><span class="glyphicon glyphicon-cog"></span>&nbsp;&nbsp;我发布的民宿</a></li>
                        <li><a href="<%=basePath %>OrderInfo/szFrontlist"><span class="glyphicon glyphicon-heart"></span>&nbsp;&nbsp;我收到的订单</a></li>
                        <li><a href="<%=basePath %>Comment/szFrontlist"><span class="glyphicon glyphicon-user"></span>&nbsp;&nbsp;我收到的评论</a></li>
                        <li><a href="<%=basePath %>Owner/owner_frontSelfModify.jsp"><span class="glyphicon glyphicon-credit-card"></span>&nbsp;&nbsp;修改个人资料</a></li>
                    </ul>
                </li>
