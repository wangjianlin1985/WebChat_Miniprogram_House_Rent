...
<jsp:include page="../header.jsp"></jsp:include>
			...
			<div class="col-md-3 bottom15" <%=clearLeft %>>
			  <a  href="<%=basePath  %>Minsu/<%=minsu.getMinsuId() %>/frontshow"><img class="img-responsive" src="<%=basePath%><%=minsu.getMinsuPhoto()%>" /></a>
			     <div class="showFields">
			        ...
			        <a class="btn btn-primary top5" onclick="minsuEdit('<%=minsu.getMinsuId() %>');">修改</a>
			        <a class="btn btn-primary top5" onclick="minsuDelete('<%=minsu.getMinsuId() %>');">删除</a>
			     </div>
			</div>
			<%  } %>
	...
	<div class="col-md-3 wow fadeInRight">
		...
		<form name="minsuQueryForm" id="minsuQueryForm" action="<%=basePath %>Minsu/szFrontlist" class="mar_t15" method="post">
